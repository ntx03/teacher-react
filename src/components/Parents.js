        ...
        <section className="greetings">
          <div className="parents__container">
            ...
            <ul className="parents__list">
              ...
              <ParentsDocument
                name={
                  "Рекомендация родителям детей, временно находящихся на дистанционном обучении"
                }
              ...
              <ParentsDocument
                name={
                  "Крупнейшие федеральные проекты в сфере профессиональной ориентации"
                }
              ...
              <ParentsDocument
                name={
                  "Рекомендации родителям по адаптации учащихся 5-х классов"
                }
