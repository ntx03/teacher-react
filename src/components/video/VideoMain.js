  ...
  return (
    <>
      ...
      <div className="video__block">
        <VideoCard
          link={"https://rutube.ru/play/embed/aa71b83dbd9b557e26b0339cb234db49"}
          name={
        ...
        />
        <VideoCard link={"https://www.youtube.com/embed/IjzBK53xL5M"} name={"Виртуальная экскурсия по СХПК ЖЕЛНИНСКИЙ Вагайского района."} />
      </div>
    </>
  );
}
