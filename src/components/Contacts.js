          ...
          <div className="contacts__container">
            <div className="contacts__information">
              <div className="contacts__school-container">
                <img
                  ...
                  alt="иконка школы"
                />
                <p className="contacts__text-normal">
              ...
              <div className="contacts__school-container">
                ...
                <p className="contacts__text">
                  Адрес:
                  <span className="contacts__text-normal">
              ...
              <div className="contacts__school-container">
                <img
                  className="contacts__icon"
                  src={require("../images/old-typical-phone.png")}
                  alt="иконка с телефоном"
                />
                <p className="contacts__text">
                  Телефон:
                  <span className="contacts__text-normal">
              ...
              <div className="contacts__social-network">
                ...
                <a
                  href={"https://vk.com/id6268101"}
                  target="blank"
                  className="contacts__social-network-link"
                >
                  <img
                    className="contacts__social-network-icon"
                    src={VK}
                    alt="логотип vk"
                  />
                </a>
                <a
                  href={"https://www.instagram.com/navigator_detstva_to/"}
                  target="blank"
                  className="contacts__social-network-link"
                >
                  <img
            ...
            <div className="contacts__map">
              <iframe
                ...
                frameBorder="0"
                src={
                  "https://yandex.ru/map-widget/v1/?um=constructor%3A2c0945238dd9075ae80d280cb605337be499c6c16056db4071d2ef253c7247d8&amp;source=constructor"
                }
              ></iframe>
            </div>
          </div>
          <div className="contacts__form-container">
            ...
            <form className="contacts__form" name="form_for_post_message">
              <input
                type="hidden"
                name="project_name"
                value="сайт коротаева.рф"
              ></input>
              <input
                type="hidden"
                name="admin_email"
                value="anarverd@yandex.ru"
              ></input>
              <input
                type="hidden"
                name="form_subject"
                value="сообщение с сайта коротаева.рф"
              ></input>
              <input
                type="text"
                required
