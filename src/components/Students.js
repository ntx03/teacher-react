      ...
      <main className="content">
        <div className="parents__menu">
          <ul className="parents__menu-container">
            ...
            <MenuItemPage
              way={"/students/platform"}
              text={"ПЛАТФОРМЫ ПОМОЩНИКИ"}
              onPage={platform}
            />

            <MenuItemPage
              way={"/students/examination"}
          ...
          <div className="students__container">
            <div className="students__cards-container">
              <Route exact path="/students">
                <StudentsCard
                  link={kids6}
                  name={"Безопасное поведение на льду водоема"}
                />
                <StudentsCard
                  link={на_улице}
                  name={"Безопасное поведение на улице"}
                />
                <StudentsCard
                  link={при_пожаре}
                  name={"Безопасное поведение при пожаре"}
                />
                <StudentsCard
                  link={школа}
                  name={"Школа дорожной безопасности"}
                />
                <StudentsCard
                  link={советы}
                  name={"Советы начинающим велосипедистам"}
                />
                <StudentsCard
                  link={поведение}
                  name={"Поведение при террорестических угрозах"}
                />
              </Route>
              <Route exact path="/students/platform">
                <StudentsWebsait
                  ...
                  altImage={
                    "фотография главной страницы сайта Российская электронная школа"
                  }
                />
                <StudentsWebsait
                  name={'САЙТ "Я КЛАСС"'}
                ...
                <StudentsWebsait
                  name={
                    'САЙТ "Учи.ру" — интерактивная образовательная онлайн-платформа'
                  }
                  link={"https://uchi.ru/"}
                  title={
                ...
                <StudentsWebsait
                  name={
                    'САЙТ "Skysmart" — цифровая образовательная онлайн-платформа'
                  }
                ...
                <StudentsWebsait
                  name={
                    'САЙТ "Атлас новых профессий" - Ваш навигатор по рынку труда будущего'
                  }
                  link={"https://new.atlas100.ru/"}
                  title={"Ваш навигатор по рынку труда будущего"}
                  linkImage={require("../images/Атлас будущих професии.jpg")}
                  altImage={
                    "фотография главной страницы сайта Атлас будущих професий"
                  }
                />
              </Route>
